from autocom.gate_util import *
from autocom.commute_func import *
from autocom.merge_func import *
...
def autocomm_full(gate_list, qubit_node_mapping, allow_gate_pattern=False, allow_test_merge=False, allow_local_view=False, aggregate_iter_cnt=1, schedule_iter_cnt=1):
    if allow_local_view == False:
        ...
        epr_cnt, all_latency, assigned_gate_block_list_scheduled = comm_schedule(assigned_gate_block_list, qubit_node_mapping, refine_iter_cnt=schedule_iter_cnt)
        return epr_cnt, all_latency, assigned_gate_block_list_scheduled
    else:
        g_list = []
